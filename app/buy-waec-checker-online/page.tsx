...
import { CheckCircle2, KeyRound, ArrowRight, Smartphone, ShieldCheck, Zap, HelpCircle } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-[#f8fafc]">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-6 rounded-2xl bg-white border-2 border-red-500/80 shadow-md space-y-4 relative">
