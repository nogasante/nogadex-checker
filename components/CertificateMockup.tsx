...
import { FileCheck, ShieldCheck, Download, Check } from "lucide-react";

export function CertificateMockup() {
  return (
    <div className="relative rounded-2xl bg-white border border-slate-200/90 p-4 sm:p-5 shadow-xs space-y-3 select-none">
      {/* Top Banner */}
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-3.5 space-y-2.5 font-sans">
        {/* Certificate Header */}
